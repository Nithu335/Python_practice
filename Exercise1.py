# -*- coding: utf-8 -*-
"""
Created on Wed Jun  9 11:08:06 2021
...
def celsius_to_fahrenheit(temp):
    """Converts Celcuis temperature to Fahrenhiet"""
    newTemp= ((9/5) * temp) + 32
    print("The Celsius temperature {} is equivalent to {} degrees Fahrenheit".format(temp,newTemp))
#%%
...
def name():
    ...
    sname = input("Enter the state you live in:")
    fulladd = cname + "," + sname
    fullname = fname + " " + lname

    print("Your name is:", fullname)
    print("You live in:{}".format(fulladd))
#%%
"""
Solution:
"""
...
def absolutevalue(num):
    if num > 0:
        ...
        value=num
    print("Tha absolute value of {} is {}".format(num,value))
#%%
# Test runs
absolutevalue(5)
absolutevalue(-5)
